        ...
        <>
            <div className="min-w-full min-h-full max-w-sm bg-white border border-gray-200 shadow rounded-tr-lg rounded-bl-lg">
                ...
                <div className="p-5">
                    ...
                    {
                        sitePath ?
                            <a href={sitePath} target="_blank" className="mb-3 mr-3 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-300 " rel="noreferrer">
                                Visit the site
                    ...
                    {
                        repositoryPath ?
                            <a href={repositoryPath} target="_blank" className="mb-3 mr-3 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-300 " rel="noreferrer">
                                Repository
                                <svg aria-hidden="true" className="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                            </a>
                            :
